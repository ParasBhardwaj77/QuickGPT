  ...
  const deleteChat = async (e, chatId) => {
    try {
      ...
      const { data } = await axios.delete("/api/chat/delete", {
        ...
        data: { chatId }, // axios.delete requires data in "data" property
      });
        ...
        {chats
          ...
          .map((chat) => (
            <div
              ...
              key={chat._id}
              className="p-2 px-4 dark:bg-[#57317C]/10 border border-gray-300 dark:border-[#57317C]/15 rounded-md cursor-pointer flex justify-between group"
            >
              <div>
